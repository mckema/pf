...
<div id="header-section">
	...
	<div class="container">
		<div id="title-container">
        	<h2>Reset my PublishForce password</h2>
        </div>
        <!-- CLOSE HEADING DIVS -->
    </div>
</div>
<!-- CLOSE HEADING DIVS -->
    ...
    <div class="white-section">
        ...
        <h3>
        <?php
        if( $login_error_msg == "mismatching_passwords" )
		{
		...
		{
				Print("enter your new password for $userId:"); 
        ...
        <form id="loginForm" method="POST" action="login_helper.php">
        	<!--<span class="login-form">-->
        		Password: &nbsp;
        		<input type="password" class="user-password" name="user_password" id="user_password" style="width: 40;" autofocus />
        		&nbsp;
        		Re-enter Password: &nbsp;
        		<input type="password" class="user-password" name="user_password_2" id="user_password_2" style="width: 40;" />
        		&nbsp;
        		<input name="submit_new_password" type="submit" value=" Change password ">
