...
<!-- CLOSE HEADING DIVS -->
    ...
    <div class="white-section">
        <div class="container">
        <h3>Budget Summary and linked RPAs</h3>
        <p>
        << <a href="budget_home.php">Back</a> to my list of Budgets<br/>
<?php
		...
		$sql = "select a.budget_id, a.budget_name, a.asset_owner_id, b.asset_owner_name, a.budget_ccy,
		a.budget_amount, a.start_date, a.end_date, a.creation_date, a.active_flag
		from pf_budget_AO a, pf_asset_owner_details b 
		where a.asset_owner_id = b.asset_owner_id and a.budget_id = $budgetId";
		$result = $connection->query($sql);
		
		//which funds are linked to this RPA
        //$chosenFundsSQL = "select * from pf_funds_linked_to_rpa where rpa_id = $rpaId;";
        $chosenRPAsSQL = "SELECT b.ISIN, FORMAT(SUM(b.allocation_amount),2) total, FORMAT(a.fund_limit_amount,2) fund_limit_amount, a.fund_ccy
...
<?php
		...
		if ($result->num_rows > 0) {
    		...
    		while($row = $result->fetch_assoc()) {
        		...
        		echo "<tr>
        			<td width='160'>Budget name: </td><td width='600'>" . $row["budget_name"]. "</td>
        		</tr>
        		<tr>
        			<td>Asset owner: </td>
        			<td>
        		...
        		<tr>
        			<td>Budget spent: <strong>(SHOW SUM OF RPA SPENDING)</strong></td>";
