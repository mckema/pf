...
<?php
		...
		$sql = "select * from pf_csa_details where csa_id = $csaId";
...
<?php
		...
		if ($result->num_rows > 0) {
    		...
    		while($row = $result->fetch_assoc()) {
        		...
        		echo "<tr>
        		<td width='100'>CSA name: </td><td width='600'><input type='text' class='search-text' name='csa_name' id='csa_name' value='" . $row["csa_name"]. "'/></td></tr>
        		<tr>
        			<td>Budget name: </td>
        			<td>
    				...
    				echo "</select>
        			<input type='hidden' name='csa_id' id='csa_id' value='". $row["csa_id"] . "'/>
        			</td>
        		</tr>
        		<tr>
        			<td>Asset owner: </td>
