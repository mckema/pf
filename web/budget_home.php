...
<!-- CLOSE HEADING DIVS -->
    ...
    <div class="white-section">
        <div class="container">
        <h3>Manage my research budgets</h3>
        <p>
        	<a href="edit_budget.php?action=create">Create a new research budget</a>
...
<?php
		...
		if ($result->num_rows > 0) {  // && $searchTag!="") {
    		...
    		while($row = $result->fetch_assoc()) {
        		...
        		<td>" . $rpa_status . "</td>
        		<td>[ <a href='view_budget.php?budget_id=" . $row["budget_id"] . "'>details</a> ]</td>
        		</tr>";
    		}
		} else {
