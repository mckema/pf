...
<div class="white-section">
	<div class="container">
        <h3>PublishForce is designed to help you</h3>
			<p>
				The PublishForce platform is built on an Oracle MySql database with an HTML user interface (using PHP). 
				Thus, a user with internet access can login securely and transact with PublishForce.
			</p>
			<p>
				Our system is hosted securely with Amazon Web Services.
			</p>
